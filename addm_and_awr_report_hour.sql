...
PROMPT ************************************
PROMPT
ACCEPT DDATE date format 'YYYY-MM-DD HH24' PROMPT 'Enter report start time (YYYY-MM-DD  HH24): '
ACCEPT DDATE2 date format 'YYYY-MM-DD HH24' PROMPT 'Enter report end time (YYYY-MM-DD  HH24): '
...
begin
  ...
  select min(SNAP_ID),
   ...
   where BEGIN_INTERVAL_TIME between to_date ('&DDATE','YYYY-MM-DD HH24') and to_date ('&DDATE2','YYYY-MM-DD HH24')
